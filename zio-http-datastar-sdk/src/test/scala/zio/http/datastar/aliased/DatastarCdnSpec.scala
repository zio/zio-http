  ...
  override def spec: Spec[Any, Any] = suite("DatastarCdnSpec")(
    ...
    suite("integration with datastar attributes")(
      test("mainPage with attributes") {
        ...
        assertTrue(
          rendered.contains("data-star-signals"),
          rendered.contains("data-star-on:click"),
          rendered.contains("data-star-text"),
          renderedSignal,
          rendered.contains("datastar-aliased.js"),
        )
      },
    ),
  )
