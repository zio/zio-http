...
object Dependencies {
  ...
  val `jsoniter-core`   = "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-core"   % "2.13.9"
  val `jsoniter-macros` = "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "2.13.9" % "provided"
