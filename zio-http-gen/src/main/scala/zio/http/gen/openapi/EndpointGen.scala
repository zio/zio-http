  ...
  def schemaToField(
    ...
    schema match {
      ...
      case JsonSchema.Integer(
        ...
        Some(Code.Field(name, Code.Primitive.ScalaInt, annotations.map(Code.Annotation)))
      case JsonSchema.Integer(
        ...
        Some(Code.Field(name, Code.Primitive.ScalaLong, annotations.map(Code.Annotation)))
      case JsonSchema.Integer(
      ...
      case JsonSchema.String(Some(JsonSchema.StringFormat.UUID), _, maxLength, minLength)                             =>
        ...
        Some(Code.Field(name, Code.Primitive.ScalaUUID, annotations.map(Code.Annotation)))
      case JsonSchema.String(_, _, maxLength, minLength)                                                              =>
        ...
        Some(Code.Field(name, Code.Primitive.ScalaString, annotations.map(Code.Annotation)))
      case JsonSchema.Boolean                                                                                         =>
      ...
      case JsonSchema.Number(JsonSchema.NumberFormat.Double, minimum, exclusiveMinimum, maximum, exclusiveMaximum, _) =>
        ...
        Some(Code.Field(name, Code.Primitive.ScalaDouble, annotations.map(Code.Annotation)))
      case JsonSchema.Number(JsonSchema.NumberFormat.Float, minimum, exclusiveMinimum, maximum, exclusiveMaximum, _)  =>
        ...
        Some(Code.Field(name, Code.Primitive.ScalaFloat, annotations.map(Code.Annotation)))
