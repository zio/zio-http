...
object Body {
  ...
  /**
   * Constructs a [[zio.http.Body]] from a CharSequence
   */
  def fromCharSequence(
    charSequence: CharSequence,
    charset: Charset = Charsets.Http,
  )(implicit bodyEncoding: BodyEncoding): Body =
    bodyEncoding.fromCharSequence(charSequence, charset)
   ...
   */
  def fromString(text: String, charset: Charset = Charsets.Http)(implicit bodyEncoding: BodyEncoding): Body =
   ...
   */
  def fromURLEncodedForm(form: Form, charset: Charset = StandardCharsets.UTF_8)(implicit bodyEncoding: BodyEncoding): Body = {
  ...
  private[http] val zioEmptyArray = ZIO.succeed(Array.empty[Byte])(Trace.empty)

  private[http] val zioEmptyChunk = ZIO.succeed(Chunk.empty[Byte])(Trace.empty)
