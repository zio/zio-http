...
private[http] sealed trait BodyCodec[A] { self =>
   ...
   * Encodes the `A` to a body in the given codec.
   */
  def encodeToBody(value: A, codec: Codec[String, Char, Element])(implicit trace: Trace, bodyEncoding: BodyEncoding): Body
...
private[http] object BodyCodec {
  case object Empty extends BodyCodec[Unit] {
    ...
    def encodeToBody(value: Unit, codec: Codec[String, Char, Unit])(implicit trace: Trace, be:BodyEncoding): Body = Body.empty
  ...
  final case class Single[A](schema: Schema[A], mediaType: Option[MediaType], name: Option[String])
    ...
    def encodeToBody(value: A, codec: Codec[String, Char, A])(implicit trace: Trace, be: BodyEncoding): Body =
  ...
  final case class Multiple[E](schema: Schema[E], mediaType: Option[MediaType], name: Option[String])
    ...
    def encodeToBody(value: ZStream[Any, Nothing, E], codec: Codec[String, Char, E])(implicit trace: Trace, be: BodyEncoding): Body =
