...
object Header {
  ...
  sealed trait HeaderType {
    ...
    def parse(value: String)(implicit encoding: DateEncoding): Either[String, HeaderValue]

    def render(value: HeaderValue)(implicit encoding: DateEncoding): String
  }
  ...
  object Date extends HeaderType {
    ...
    def parse(value: String)(implicit encoding: DateEncoding): Either[String, Date] =
      encoding.decodeDate(value).toRight("Invalid Date header").map(Date(_))

    def render(date: Date)(implicit encoding: DateEncoding): String =
      encoding.encodeDate(date.value)
  }
  ...
  object Expires extends HeaderType {
    ...
    def parse(date: String)(implicit encoding: DateEncoding): Either[String, Expires] =
      encoding.decodeDate(date).toRight("Invalid Expires header").map(Expires(_))

    def render(expires: Expires)(implicit encoding: DateEncoding): String =
      encoding.encodeDate(expires.value)
  }
  ...
  object IfModifiedSince extends HeaderType {
    ...
    def parse(value: String)(implicit encoding: DateEncoding): Either[String, IfModifiedSince] =
      encoding.decodeDate(value).toRight("Invalid If-Modified-Since header").map(IfModifiedSince(_))

    def render(ifModifiedSince: IfModifiedSince)(implicit encoding: DateEncoding): String =
      encoding.encodeDate(ifModifiedSince.value)
  }
