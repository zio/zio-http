...
//   val testLayer: ZLayer[Any, Throwable, Server] =
//     ZLayer.make[Server](
//       Server.live,
...
//         val app = routes.toApp @@ alwaysFailingMiddleware.implement[Any, Unit](_ => ZIO.fail("FAIL"))(_ => ZIO.unit).toHandlerAspect.toMiddleware
...
//         }
//       } @@ timeout(10.seconds) @@ ifEnvNotSet("CI"), // NOTE: random hangs on CI
//     ).provide(testLayer) @@ withLiveClock @@ sequential @@ timeout(300.seconds)
// }
