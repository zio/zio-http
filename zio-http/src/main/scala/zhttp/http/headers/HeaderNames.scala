...
/**
 * List of commonly used HeaderNames. They are provided to reduce bugs caused by typos and also to improve performance.
 * `HeaderNames` aren't encoded every time it needs to be sent over the wire.
 */
trait HeaderNames {
