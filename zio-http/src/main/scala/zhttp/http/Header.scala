...
object Header {
  ...
  private[zhttp] def setCookie(value: String): Header = Header(HttpHeaderNames.SET_COOKIE, value)
  private[zhttp] def cookie(value: String): Header    = Header(HttpHeaderNames.COOKIE, value)
