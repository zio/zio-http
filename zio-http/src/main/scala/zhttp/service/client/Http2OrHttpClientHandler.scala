...
import zhttp.service.{CLIENT_CODEC_HANDLER, HTTP2_CONNECTION_HANDLER, HTTP2_RESPONSE_HANDLER, HTTP2_SETTINGS_HANDLER, HTTP_RESPONSE_HANDLER, OBJECT_AGGREGATOR}

final case class Http2OrHttpClientHandler(ch: Channel,
