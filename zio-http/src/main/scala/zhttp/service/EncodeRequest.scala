...
trait EncodeRequest {
   ...
   * @param streamId : Incase of Clear text upgrade to http2, the first message will be sent from streamId 1
   */
  def encodeRequest(jVersion: HttpVersion, req: Request, enableHttp2:Boolean=false, streamId:Int=1): FullHttpRequest = {
