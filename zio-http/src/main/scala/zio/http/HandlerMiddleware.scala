...
object HandlerMiddleware {
  ...
  implicit final class MonoMethods[R, Err, AIn, AOut, BIn <: AIn, BOut](
    val self: HandlerMiddleware.Mono[Nothing, R, Err, Any, AIn, AOut, BIn, BOut],
  ) extends AnyVal {
    def when(
      condition: BIn => Boolean,
    )(implicit
      trace: Trace,
      ev: IsMono[AIn, AOut, BIn, BOut],
    ): HandlerMiddleware.Mono[Nothing, R, Err, Any, AIn, AOut, BIn, BOut] =
      new HandlerMiddleware[Nothing, R, Err, Any, AIn, AOut, BIn, BOut] {
        ...
        override def apply[R1 <: R, Err1 >: Err](handler: Handler[R1, Err1, AIn, AOut])(implicit
          ...
          Handler.fromFunctionHandler[BIn].apply[R1, Err1, BOut] { in =>
            if (condition(in)) {
    ...
    def whenZIO[R1 <: R, Err1 >: Err, BIn1 <: BIn](
      ...
      trace: Trace,
      ev: IsMono[AIn, AOut, BIn, BOut],
    ): HandlerMiddleware.Mono[Nothing, R1, Err1, Any, AIn, AOut, BIn1, BOut] =
      new HandlerMiddleware[Nothing, R1, Err1, Any, AIn, AOut, BIn1, BOut] {
