...
trait HandlerMiddleware[-R, +Err, +AIn, -AOut, -BIn <: AIn, +BOut]
  ...
  final def andThen[R1 <: R, Err1 >: Err, AIn1 <: BIn, AOut1 >: BOut, BIn1 <: AIn1, BOut1](
    ...
    new HandlerMiddleware[R1, Err1, AIn, AOut, BIn1, BOut1] {
      override def apply[R2 <: R1, Err2 >: Err1](
        handler: Handler[R2, Err2, AIn, AOut],
  ...
  )(implicit ev: IsMono[AIn, AOut, BIn, BOut]): HandlerMiddleware[R, Err, AIn, AOut, BIn1, BOut] =
    new HandlerMiddleware[R, Err, AIn, AOut, BIn1, BOut] {
      override def apply[R1 <: R, Err1 >: Err](handler: Handler[R1, Err1, AIn, AOut]): Handler[R1, Err1, BIn1, BOut] =
  ...
  )(implicit ev: IsMono[AIn, AOut, BIn, BOut]): HandlerMiddleware[R1, Err1, AIn, AOut, BIn1, BOut] =
    new HandlerMiddleware[R1, Err1, AIn, AOut, BIn1, BOut] {
      override def apply[R2 <: R1, Err2 >: Err1](handler: Handler[R2, Err2, AIn, AOut]): Handler[R2, Err2, BIn1, BOut] =
        Handler
