...
trait Middleware[-R, +E, +AIn, -BIn, -AOut, +BOut] { self =>
   ...
   */
  final def <>[R1 <: R, E1 >: E, AIn0 >: AIn, BIn0 <: BIn, AOut0 <: AOut, BOut0 >: BOut](
  ...
  final def map[BOut0](f: BOut => BOut0): Middleware[R, E, AIn, BIn, AOut, BOut0] =
    new Middleware[R, E, AIn, BIn, AOut, BOut0] {
      override def apply[R1 <: R, E1 >: E](http: Http[R1, E1, AIn, BIn])(implicit
        trace: Trace,
      ): Http[R1, E1, AOut, BOut0] =
        self(http).map(f)
    }
  ...
  final def mapZIO[R1 <: R, E1 >: E, BOut0](f: BOut => ZIO[R1, E1, BOut0]): Middleware[R1, E1, AIn, BIn, AOut, BOut0] =
    new Middleware[R1, E1, AIn, BIn, AOut, BOut0] {
      def apply[R2 <: R1, E2 >: E1](http: Http[R2, E2, AIn, BIn])(implicit trace: Trace): Http[R2, E2, AOut, BOut0] =
        self(http).mapZIO(f)
    }
   ...
   * Applies self but if it fails, applies other.
   */
  final def orElse[R1 <: R, E1 >: E, AIn0 >: AIn, BIn0 <: BIn, AOut0 <: AOut, BOut0 >: BOut](
    other: Middleware[R1, E1, AIn0, BIn0, AOut0, BOut0],
  ...
  final def runAfter[R1 <: R, E1 >: E](effect: ZIO[R1, E1, Any]): Middleware[R1, E1, AIn, BIn, AOut, BOut] =
    new Middleware[R1, E1, AIn, BIn, AOut, BOut] {
      def apply[R2 <: R1, E2 >: E1](http: Http[R2, E2, AIn, BIn])(implicit trace: Trace): Http[R2, E2, AOut, BOut] =
  ...
  ): Middleware[R, E, AIn, BIn, AOut0, BOut] =
...
object Middleware extends Web {
  ...
  def allow[A, B](cond: A => Boolean): Middleware[Any, Nothing, A, B, A, B] =
    new Middleware[Any, Nothing, A, B, A, B] {
      override def apply[R1 <: Any, E1 >: Nothing](http: Http[R1, E1, A, B])(implicit
        trace: Trace,
      ): Http[R1, E1, A, B] =
        Http.collectHttp { case a if cond(a) => http }
    }
...
//      new Middleware[R, E, A, B, A, B] {
//        override def apply[R1 <: R, E1 >: E](http: Http[R1, E1, A, B])(implicit
//          trace: Trace,
//        ): Http[R1, E1, A, B] =
//          Http.fromFunctionZIO[A](a => cond(a).map(if (_) http else Http.empty)).flatten
//      }
//  }
  ...
  final class PartialMono[AOut, BIn](val unit: Unit) extends AnyVal {
    def apply[AIn, BOut](
      ...
      new Middleware[Any, Nothing, AIn, BIn, AOut, BOut] {
        override def apply[R1 <: Any, E1 >: Nothing](http: Http[R1, E1, AIn, BIn])(implicit
          trace: Trace,
        ): Http[R1, E1, AOut, BOut] =
  ...
  final class PartialMonoTotal[AOut, BIn](val unit: Unit) extends AnyVal {
    def apply[AIn, BOut](
      in: AOut => AIn,
      out: BIn => BOut,
    ): Middleware.ForTotal[Any, Nothing, AIn, BIn, AOut, BOut] =
      new Middleware.ForTotal[Any, Nothing, AIn, BIn, AOut, BOut] {
...
//          trace: Trace,
//        ): Http[R1, E1, AOut, BOut] =
//          Http.collectZIO[AOut] { case a if f.isDefinedAt(a) => f(a).map(_(http)) }.flatten
//      }
//  }
  ...
  final class PartialInterceptZIOTotal[A, B](val unit: Unit) extends AnyVal {
    def apply[R, E, S, BOut](
      incoming: A => ZIO[R, E, S],
    ): PartialInterceptOutgoingZIOTotal[R, E, A, S, B] =
      new PartialInterceptOutgoingZIOTotal(incoming)
  }
  ...
  final class PartialInterceptOutgoingZIOTotal[-R, +E, A, +S, B](val incoming: A => ZIO[R, E, S]) extends AnyVal {
    def apply[R1 <: R, E1 >: E, BOut](
      outgoing: (B, S) => ZIO[R1, E1, BOut],
    ): Middleware.ForTotal[R1, E1, A, B, A, BOut] =
      new Middleware.ForTotal[R1, E1, A, B, A, BOut] {
  ...
  final class PartialIfThenElse[AOut](val unit: Unit) extends AnyVal {
    def apply[R, E, AIn, BIn, BOut](cond: AOut => Boolean)(
      ...
      new Middleware[R, E, AIn, BIn, AOut, BOut] {
        override def apply[R1 <: R, E1 >: E](http: Http[R1, E1, AIn, BIn])(implicit
          trace: Trace,
        ): Http[R1, E1, AOut, BOut] = Http.collectHttp {
          case a if cond(a) && isTrue(a)(http).execute.isDefinedAt(a)   =>
            isTrue(a)(http)
          case a if !cond(a) && isFalse(a)(http).execute.isDefinedAt(a) =>
            isFalse(a)(http)
        }
      }
  }
  ...
  trait ForTotal[-R, +E, +AIn, -BIn, -AOut, +BOut] { self =>
     ...
     */
    final def andThen[R1 <: R, E1 >: E, AIn1 <: AOut, BIn1 >: BOut, AOut1, BOut1](
      other: Middleware.ForTotal[R1, E1, AIn1, BIn1, AOut1, BOut1],
    ): Middleware.ForTotal[R1, E1, AIn, BIn, AOut1, BOut1] =
      new Middleware.ForTotal[R1, E1, AIn, BIn, AOut1, BOut1] {
        override def apply[R2 <: R1, E2 >: E1](http: Http.Total[R2, E2, AIn, BIn])(implicit
          trace: Trace,
     ...
     * Preprocesses the incoming value for the outgoing Http.
     */
    final def contramap[AOut0](f: AOut0 => AOut): Middleware.ForTotal[R, E, AIn, BIn, AOut0, BOut] =
      new Middleware.ForTotal[R, E, AIn, BIn, AOut0, BOut] {
        override def apply[R1 <: R, E1 >: E](http: Http.Total[R1, E1, AIn, BIn])(implicit
          trace: Trace,
     ...
     * Transforms the output type of the current middleware.
     */
    final def map[BOut0](f: BOut => BOut0): Middleware.ForTotal[R, E, AIn, BIn, AOut, BOut0] =
      new Middleware.ForTotal[R, E, AIn, BIn, AOut, BOut0] {
        override def apply[R1 <: R, E1 >: E](http: Http.Total[R1, E1, AIn, BIn])(implicit
          trace: Trace,
    ...
    /**
     * Transforms the output type of the current middleware using effect
     * function.
     */
    final def mapZIO[R1 <: R, E1 >: E, BOut0](
      f: BOut => ZIO[R1, E1, BOut0],
    ): Middleware.ForTotal[R1, E1, AIn, BIn, AOut, BOut0] =
      new Middleware.ForTotal[R1, E1, AIn, BIn, AOut, BOut0] {
