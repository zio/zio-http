 ...
 *
 * The [[zio.http.Middleware]] is more than just a [[zio.http.ProtocolStack]],
 * as its concatenation operator has been specialized to union ZIO environments,
 * to ensure that each layer may only add context to the contextual output.
 */
