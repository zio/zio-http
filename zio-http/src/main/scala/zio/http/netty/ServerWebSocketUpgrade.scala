 ...
 */
private[zio] trait ServerWebSocketUpgrade[R] { self: ServerInboundHandler[R] =>
    ...
    jReq match {
      case jReq: FullHttpRequest =>
        ...
        ctx
          ...
          .addLast(service.WEB_SOCKET_HANDLER, new WebSocketAppHandler(runtime, app.get, false))
...
object ServerWebSocketUpgrade {
  private[zio] val log = service.Log.withTags("Server", "WebSocket")
}
