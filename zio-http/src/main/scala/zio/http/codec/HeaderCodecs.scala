...
private[codec] trait HeaderCodecs {
  ...
  final val cookie: HeaderCodec[Header.RequestCookie]                            = header(Header.RequestCookie)
  ...
  final val setCookie: HeaderCodec[Header.ResponseCookie]                        = header(Header.ResponseCookie)
