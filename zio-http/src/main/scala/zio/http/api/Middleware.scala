...
object Middleware {
  ...
  final case class HandlerZIO[-R, +E, I, O](handler: I => ZIO[R, E, O]) extends Middleware[R, E, I, O]

  final case class Handler[I, O](handler: I => O) extends Middleware[Any, Nothing, I, O]
