...
import java.nio.charset.{Charset, StandardCharsets} // scalafix:ok;

private[zio] trait RequestLoggingForTotal {
  ...
  )(implicit trace: Trace): HttpMiddlewareForTotal[Any, Throwable] =
    Middleware.ForTotal.interceptZIOPatch { request =>
