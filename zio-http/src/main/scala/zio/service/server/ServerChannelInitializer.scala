...
import zio.service.Server.Config
import zio.service._
import zio.service.server.LogLevelTransform._
import zio.service.server.ServerChannelInitializer.log
...
final case class ServerChannelInitializer[R](
  ...
  override def initChannel(channel: Channel): Unit = {
    ...
    if (EnableNettyLogging) {
      ...
      InternalLoggerFactory.setDefaultFactory(zio.service.logging.NettyLoggerFactory(log))
