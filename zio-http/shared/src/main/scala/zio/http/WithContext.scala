...
//
//  implicit def zioWithContextConstructor[Env0, Err0, Out0]
//    : WithContext.Typed[ZIO[Env0, Err0, Out0], Env0, Err0, Out0] =
//    new WithContext[ZIO[Env0, Err0, Out0]] {
//      type Env = Env0
//      type Err = Err0
//      type Out = Out0
...
//    }
//
//  implicit def responseWithContextConstructor: WithContext.Typed[Response, Any, Nothing, Response] =
//    new WithContext[Response] {
//      type Env = Any
//      type Err = Nothing
//      type Out = Response
//      type Z   = Response
...
//    }
//
//  implicit def exitWithContextConstructor[E, A]: WithContext.Typed[Exit[E, A], Any, E, Any, A] =
//    new WithContext[Exit[E, A]] {
//      type Env = Any
//      type Err = E
//      type Out = A
//      type Z   = Exit[E, A]
...
//    }
//
//  implicit def eitherWithContextConstructor[Err0, Out0]: WithContext.Typed[Either[Err0, Out0], Any, Err0, Any, Out0] =
//    new WithContext[Either[Err0, Out0]] {
//      type Env = Any
//      type Err = Err0
//      type Out = Out0
...
//    }
//
//  implicit def tryWithContextConstructor[Out0]: WithContext.Typed[Try[Out0], Any, Throwable, Any, Out0] =
//    new WithContext[Try[Out0]] {
//      type Env = Any
//      type Err = Throwable
//      type Out = Out0
//      type Z   = Try[Out0]
