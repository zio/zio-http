...
lazy val `vnd.ms-works`: MediaType =
  new MediaType("application", "vnd.ms-works", compressible = false, binary = true, List("wps", "wks", "wcm", "wdb"))
...
lazy val `vnd.collabio.xodocuments.presentation-template`: MediaType =
  new MediaType("application", "vnd.collabio.xodocuments.presentation-template", compressible = false, binary = true)
...
lazy val `vnd.anser-web-funds-transfer-initiation`: MediaType =
  new MediaType("application", "vnd.anser-web-funds-transfer-initiation", compressible = false, binary = true, List("fti"))
...
lazy val `vnd.oasis.opendocument.text-template`: MediaType =
  new MediaType("application", "vnd.oasis.opendocument.text-template", compressible = false, binary = true, List("ott"))
    

lazy val `vnd.openxmlformats-officedocument.spreadsheetml.revisionlog+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.spreadsheetml.revisionlog+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.wordprocessingml.endnotes+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.wordprocessingml.endnotes+xml", compressible = true, binary = true)
...
lazy val `vnd.oasis.opendocument.presentation`: MediaType =
  new MediaType("application", "vnd.oasis.opendocument.presentation", compressible = false, binary = true, List("odp"))
...
lazy val `x-virtualbox-vbox-extpack`: MediaType =
  new MediaType("application", "x-virtualbox-vbox-extpack", compressible = false, binary = true, List("vbox-extpack"))
...
lazy val `vnd.oasis.opendocument.image-template`: MediaType =
  new MediaType("application", "vnd.oasis.opendocument.image-template", compressible = false, binary = true, List("oti"))
...
lazy val `vnd.openxmlformats-officedocument.spreadsheetml.sheet`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.spreadsheetml.sheet", compressible = false, binary = true, List("xlsx"))
...
lazy val `x-zmachine`: MediaType =
  new MediaType("application", "x-zmachine", compressible = false, binary = true, List("z1", "z2", "z3", "z4", "z5", "z6", "z7", "z8"))
...
lazy val `vnd.openxmlformats-officedocument.wordprocessingml.document.glossary+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.wordprocessingml.document.glossary+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.drawingml.diagramstyle+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.drawingml.diagramstyle+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.drawingml.diagramlayout+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.drawingml.diagramlayout+xml", compressible = true, binary = true)
    

lazy val `vnd.openxmlformats-officedocument.presentationml.slideshow.main+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.presentationml.slideshow.main+xml", compressible = true, binary = true)
...
lazy val `vnd.nokia.n-gage.symbian.install`: MediaType =
  new MediaType("application", "vnd.nokia.n-gage.symbian.install", compressible = false, binary = true, List("n-gage"))
...
lazy val `vnd.cluetrust.cartomobile-config-pkg`: MediaType =
  new MediaType("application", "vnd.cluetrust.cartomobile-config-pkg", compressible = false, binary = true, List("c11amz"))
...
lazy val `vnd.openxmlformats-officedocument.presentationml.notesmaster+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.presentationml.notesmaster+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.presentationml.slideshow`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.presentationml.slideshow", compressible = false, binary = true, List("ppsx"))
...
lazy val `vnd.openxmlformats-officedocument.wordprocessingml.footer+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.wordprocessingml.footer+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.presentationml.slide`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.presentationml.slide", compressible = false, binary = true, List("sldx"))
...
lazy val `vnd.ms-word.template.macroenabled.12`: MediaType =
  new MediaType("application", "vnd.ms-word.template.macroenabled.12", compressible = false, binary = true, List("dotm"))
    

lazy val `vnd.openxmlformats-officedocument.presentationml.slide+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.presentationml.slide+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.wordprocessingml.template`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.wordprocessingml.template", compressible = false, binary = true, List("dotx"))
...
lazy val `vnd.openxmlformats-officedocument.presentationml.template`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.presentationml.template", compressible = false, binary = true, List("potx"))
...
lazy val `onenote`: MediaType =
  new MediaType("application", "onenote", compressible = false, binary = true, List("onetoc", "onetoc2", "onetmp", "onepkg"))
...
lazy val `vnd.openxmlformats-officedocument.wordprocessingml.fonttable+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.wordprocessingml.fonttable+xml", compressible = true, binary = true)
...
lazy val `vnd.oasis.opendocument.formula-template`: MediaType =
  new MediaType("application", "vnd.oasis.opendocument.formula-template", compressible = false, binary = true, List("odft"))
...
lazy val `vnd.openxmlformats-officedocument.spreadsheetml.revisionheaders+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.spreadsheetml.revisionheaders+xml", compressible = true, binary = true)
...
lazy val `vnd.ms-word.document.macroenabled.12`: MediaType =
  new MediaType("application", "vnd.ms-word.document.macroenabled.12", compressible = false, binary = true, List("docm"))
...
lazy val `x-director`: MediaType =
  new MediaType("application", "x-director", compressible = false, binary = true, List("dir", "dcr", "dxr", "cst", "cct", "cxt", "w3d", "fgd", "swa"))
...
lazy val `vnd.openxmlformats-officedocument.spreadsheetml.styles+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.spreadsheetml.styles+xml", compressible = true, binary = true)
...
lazy val `vnd.oma.bcast.associated-procedure-parameter+xml`: MediaType =
  new MediaType("application", "vnd.oma.bcast.associated-procedure-parameter+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.presentationml.presentation`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.presentationml.presentation", compressible = false, binary = true, List("pptx"))
...
lazy val `vnd.openxmlformats-officedocument.presentationml.handoutmaster+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.presentationml.handoutmaster+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.spreadsheetml.template`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.spreadsheetml.template", compressible = false, binary = true, List("xltx"))
...
lazy val `vnd.openxmlformats-officedocument.spreadsheetml.worksheet+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.spreadsheetml.worksheet+xml", compressible = true, binary = true)
...
lazy val `vnd.oasis.opendocument.graphics-template`: MediaType =
  new MediaType("application", "vnd.oasis.opendocument.graphics-template", compressible = false, binary = true, List("otg"))
...
lazy val `vnd.cluetrust.cartomobile-config`: MediaType =
  new MediaType("application", "vnd.cluetrust.cartomobile-config", compressible = false, binary = true, List("c11amc"))
...
lazy val `vnd.oasis.opendocument.presentation-template`: MediaType =
  new MediaType("application", "vnd.oasis.opendocument.presentation-template", compressible = false, binary = true, List("otp"))
...
lazy val `vnd.adobe.air-application-installer-package+zip`: MediaType =
  new MediaType("application", "vnd.adobe.air-application-installer-package+zip", compressible = false, binary = true, List("air"))
...
lazy val `vnd.openxmlformats-officedocument.wordprocessingml.settings+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.wordprocessingml.settings+xml", compressible = true, binary = true)
...
lazy val `vnd.ms-powerpoint.presentation.macroenabled.12`: MediaType =
  new MediaType("application", "vnd.ms-powerpoint.presentation.macroenabled.12", compressible = false, binary = true, List("pptm"))
...
lazy val `vnd.openxmlformats-officedocument.spreadsheetml.template.main+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.spreadsheetml.template.main+xml", compressible = true, binary = true)
...
lazy val `vnd.framemaker`: MediaType =
  new MediaType("application", "vnd.framemaker", compressible = false, binary = true, List("fm", "frame", "maker", "book"))
...
lazy val `vnd.llamagraphics.life-balance.desktop`: MediaType =
  new MediaType("application", "vnd.llamagraphics.life-balance.desktop", compressible = false, binary = true, List("lbd"))
...
lazy val `vnd.openxmlformats-officedocument.presentationml.tags+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.presentationml.tags+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.presentationml.slidemaster+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.presentationml.slidemaster+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.spreadsheetml.calcchain+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.spreadsheetml.calcchain+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.wordprocessingml.styles+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.wordprocessingml.styles+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.wordprocessingml.document.main+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.wordprocessingml.document.main+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.wordprocessingml.document`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.wordprocessingml.document", compressible = false, binary = true, List("docx"))
...
lazy val `vnd.ms-powerpoint.addin.macroenabled.12`: MediaType =
  new MediaType("application", "vnd.ms-powerpoint.addin.macroenabled.12", compressible = false, binary = true, List("ppam"))
...
lazy val `vnd.ms-powerpoint.slideshow.macroenabled.12`: MediaType =
  new MediaType("application", "vnd.ms-powerpoint.slideshow.macroenabled.12", compressible = false, binary = true, List("ppsm"))
...
lazy val `vnd.oasis.opendocument.chart-template`: MediaType =
  new MediaType("application", "vnd.oasis.opendocument.chart-template", compressible = false, binary = true, List("otc"))
...
lazy val `vnd.oasis.opendocument.spreadsheet`: MediaType =
  new MediaType("application", "vnd.oasis.opendocument.spreadsheet", compressible = false, binary = true, List("ods"))
...
lazy val `vnd.ibm.modcap`: MediaType =
  new MediaType("application", "vnd.ibm.modcap", compressible = false, binary = true, List("afp", "listafp", "list3820"))
...
lazy val `vnd.openxmlformats-officedocument.presentationml.viewprops+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.presentationml.viewprops+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.drawingml.diagramcolors+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.drawingml.diagramcolors+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.spreadsheetml.pivotcacherecords+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.spreadsheetml.pivotcacherecords+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.spreadsheetml.connections+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.spreadsheetml.connections+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.spreadsheetml.sheet.main+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.spreadsheetml.sheet.main+xml", compressible = true, binary = true)
...
lazy val `x-authorware-bin`: MediaType =
  new MediaType("application", "x-authorware-bin", compressible = false, binary = true, List("aab", "x32", "u32", "vox"))
...
lazy val `vnd.anser-web-certificate-issue-initiation`: MediaType =
  new MediaType("application", "vnd.anser-web-certificate-issue-initiation", compressible = false, binary = true, List("cii"))
...
lazy val `vnd.openxmlformats-officedocument.themeoverride+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.themeoverride+xml", compressible = true, binary = true)
...
lazy val `vnd.ms-excel.sheet.binary.macroenabled.12`: MediaType =
  new MediaType("application", "vnd.ms-excel.sheet.binary.macroenabled.12", compressible = false, binary = true, List("xlsb"))
...
lazy val `vnd.openxmlformats-officedocument.drawingml.diagramdata+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.drawingml.diagramdata+xml", compressible = true, binary = true)
...
lazy val `vnd.oasis.opendocument.text-master`: MediaType =
  new MediaType("application", "vnd.oasis.opendocument.text-master", compressible = false, binary = true, List("odm"))
...
lazy val `vnd.oasis.opendocument.spreadsheet-template`: MediaType =
  new MediaType("application", "vnd.oasis.opendocument.spreadsheet-template", compressible = false, binary = true, List("ots"))
...
lazy val `vnd.llamagraphics.life-balance.exchange+xml`: MediaType =
  new MediaType("application", "vnd.llamagraphics.life-balance.exchange+xml", compressible = true, binary = true, List("lbe"))
...
lazy val `vnd.openxmlformats-officedocument.spreadsheetml.pivotcachedefinition+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.spreadsheetml.pivotcachedefinition+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.spreadsheetml.table+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.spreadsheetml.table+xml", compressible = true, binary = true)
...
lazy val `vnd.quark.quarkxpress`: MediaType =
  new MediaType("application", "vnd.quark.quarkxpress", compressible = false, binary = true, List("qxd", "qxt", "qwd", "qwt", "qxl", "qxb"))
...
lazy val `vnd.ms-powerpoint.slide.macroenabled.12`: MediaType =
  new MediaType("application", "vnd.ms-powerpoint.slide.macroenabled.12", compressible = false, binary = true, List("sldm"))
...
lazy val `vnd.openxmlformats-officedocument.wordprocessingml.template.main+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.wordprocessingml.template.main+xml", compressible = true, binary = true)
...
lazy val `x-cbr`: MediaType =
  new MediaType("application", "x-cbr", compressible = false, binary = true, List("cbr", "cba", "cbt", "cbz", "cb7"))
...
lazy val `vnd.clonk.c4group`: MediaType =
  new MediaType("application", "vnd.clonk.c4group", compressible = false, binary = true, List("c4g", "c4d", "c4f", "c4p", "c4u"))
...
lazy val `vnd.openxmlformats-officedocument.wordprocessingml.footnotes+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.wordprocessingml.footnotes+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.spreadsheetml.sharedstrings+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.spreadsheetml.sharedstrings+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-package.digital-signature-xmlsignature+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-package.digital-signature-xmlsignature+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.spreadsheetml.externallink+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.spreadsheetml.externallink+xml", compressible = true, binary = true)
...
lazy val `x-font-type1`: MediaType =
  new MediaType("application", "x-font-type1", compressible = false, binary = true, List("pfa", "pfb", "pfm", "afm"))
...
lazy val `octet-stream`: MediaType =
  new MediaType("application", "octet-stream", compressible = false, binary = true, List("bin", "dms", "lrf", "mar", "so", "dist", "distz", "pkg", "bpk", "dump", "elc", "deploy", "exe", "dll", "deb", "dmg", "iso", "img", "msi", "msp", "msm", "buffer"))
    

lazy val `vnd.ms-excel.addin.macroenabled.12`: MediaType =
  new MediaType("application", "vnd.ms-excel.addin.macroenabled.12", compressible = false, binary = true, List("xlam"))
...
lazy val `vnd.openxmlformats-officedocument.spreadsheetml.querytable+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.spreadsheetml.querytable+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.spreadsheetml.volatiledependencies+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.spreadsheetml.volatiledependencies+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.extended-properties+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.extended-properties+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.presentationml.slideupdateinfo+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.presentationml.slideupdateinfo+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.spreadsheetml.tablesinglecells+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.spreadsheetml.tablesinglecells+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.presentationml.notesslide+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.presentationml.notesslide+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.custom-properties+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.custom-properties+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.spreadsheetml.dialogsheet+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.spreadsheetml.dialogsheet+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.spreadsheetml.pivottable+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.spreadsheetml.pivottable+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.drawingml.chart+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.drawingml.chart+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.presentationml.slidelayout+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.presentationml.slidelayout+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.spreadsheetml.usernames+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.spreadsheetml.usernames+xml", compressible = true, binary = true)
...
lazy val `vnd.ms-powerpoint.template.macroenabled.12`: MediaType =
  new MediaType("application", "vnd.ms-powerpoint.template.macroenabled.12", compressible = false, binary = true, List("potm"))
...
lazy val `vnd.openxmlformats-officedocument.customxmlproperties+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.customxmlproperties+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.presentationml.presprops+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.presentationml.presprops+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.wordprocessingml.numbering+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.wordprocessingml.numbering+xml", compressible = true, binary = true)
...
lazy val `x-msmetafile`: MediaType =
  new MediaType("application", "x-msmetafile", compressible = false, binary = true, List("wmf", "wmz", "emf", "emz"))
    

lazy val `vnd.openxmlformats-officedocument.presentationml.template.main+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.presentationml.template.main+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.wordprocessingml.websettings+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.wordprocessingml.websettings+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.spreadsheetml.chartsheet+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.spreadsheetml.chartsheet+xml", compressible = true, binary = true)
...
lazy val `vnd.ms-excel`: MediaType =
  new MediaType("application", "vnd.ms-excel", compressible = false, binary = true, List("xls", "xlm", "xla", "xlc", "xlt", "xlw"))
...
lazy val `vnd.dece.data`: MediaType =
  new MediaType("application", "vnd.dece.data", compressible = false, binary = true, List("uvf", "uvvf", "uvd", "uvvd"))
...
lazy val `vnd.ms-excel.sheet.macroenabled.12`: MediaType =
  new MediaType("application", "vnd.ms-excel.sheet.macroenabled.12", compressible = false, binary = true, List("xlsm"))
...
lazy val `vnd.openxmlformats-officedocument.presentationml.commentauthors+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.presentationml.commentauthors+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.presentationml.comments+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.presentationml.comments+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.drawingml.chartshapes+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.drawingml.chartshapes+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.wordprocessingml.comments+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.wordprocessingml.comments+xml", compressible = true, binary = true)
...
lazy val `x-msdownload`: MediaType =
  new MediaType("application", "x-msdownload", compressible = false, binary = true, List("exe", "dll", "com", "bat", "msi"))
...
lazy val `vnd.openxmlformats-officedocument.spreadsheetml.comments+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.spreadsheetml.comments+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.presentationml.presentation.main+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.presentationml.presentation.main+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.presentationml.tablestyles+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.presentationml.tablestyles+xml", compressible = true, binary = true)
...
lazy val `vnd.openxmlformats-officedocument.spreadsheetml.sheetmetadata+xml`: MediaType =
  new MediaType("application", "vnd.openxmlformats-officedocument.spreadsheetml.sheetmetadata+xml", compressible = true, binary = true)
...
lazy val `vnd.ms-excel.template.macroenabled.12`: MediaType =
  new MediaType("application", "vnd.ms-excel.template.macroenabled.12", compressible = false, binary = true, List("xltm"))
...
lazy val `vnd.yamaha.openscoreformat.osfpvg+xml`: MediaType =
  new MediaType("application", "vnd.yamaha.openscoreformat.osfpvg+xml", compressible = true, binary = true, List("osfpvg"))
...
lazy val `vnd.dece.graphic`: MediaType =
  new MediaType("image", "vnd.dece.graphic", compressible = false, binary = true, List("uvi", "uvvi", "uvg", "uvvg"))
...
lazy val `plain`: MediaType =
  new MediaType("text", "plain", compressible = true, binary = false, List("txt", "text", "conf", "def", "list", "log", "in", "ini"))
...
lazy val `mp4`: MediaType =
  ...
  lazy val all: List[MediaType] = List(`vnd.dlna.mpeg-tts`, `vnd.dece.video`, `1d-interleaved-parityfec`, `nv`, `vnd.directv.mpeg-tts`, `bmpeg`, `quicktime`, `h264`, `vnd.ms-playready.media.pyv`, `rtp-enc-aescm128`, `x-mng`, `celb`, `raptorfec`, `vnd.dece.pd`, `mpeg`, `smpte291`, `vnd.dece.mp4`, `encaprtp`, `vnd.dece.hd`, `h263-2000`, `vnd.iptvforum.2dparityfec-1010`, `vnd.mpegurl`, `jxsv`, `vnd.nokia.interleaved-multimedia`, `bt656`, `x-sgi-movie`, `x-fli`, `vnd.youtube.yt`, `vnd.iptvforum.ttsavc`, `h261`, `parityfec`, `3gpp-tt`, `3gpp2`, `x-ms-wmv`, `vnd.nokia.mp4vr`, `h265`, `vnd.dece.sd`, `x-ms-wm`, `vnd.iptvforum.ttsmpeg2`, `vnd.sealedmedia.softseal.mov`, `vnd.sealed.swf`, `ffv1`, `ogg`, `vnd.cctv`, `iso.segment`, `x-ms-vob`, `vp9`, `vnd.iptvforum.2dparityfec-2005`, `rtx`, `scip`, `vnd.fvt`, `mpv`, `vnd.uvvu.mp4`, `ulpfec`, `av1`, `vnd.motorola.video`, `vnd.hns.video`, `mp2p`, `h266`, `rtploopback`, `h263-1998`, `vnd.radgamettools.smacker`, `smpte292m`, `x-matroska`, `vnd.directv.mpeg`, `x-msvideo`, `flexfec`, `webm`, `raw`, `vnd.iptvforum.1dparityfec-1010`, `h264-svc`, `x-f4v`, `vnd.radgamettools.bink`, `vnd.iptvforum.1dparityfec-2005`, `h263`, `vnd.sealed.mpeg1`, `vnd.objectvideo`, `mj2`, `x-ms-asf`, `x-smv`, `3gpp`, `vc2`, `vnd.sealed.mpeg4`, `vnd.vivo`, `vnd.dece.mobile`, `pointer`, `vnd.nokia.videovoip`, `vc1`, `jpm`, `mp4v-es`, `x-ms-wmx`, `h264-rcdo`, `mpeg4-generic`, `mp2t`, `dv`, `vnd.motorola.videop`, `vnd.dvb.file`, `jpeg2000`, `vp8`, `jpeg`, `x-m4v`, `mp1s`, `x-ms-wvx`, `x-flv`, `mp4`)
...
lazy val `disposition-notification`: MediaType =
  new MediaType("message", "disposition-notification", compressible = false, binary = true, List("disposition-notification"))
...
lazy val `news`: MediaType =
  ...
  lazy val all: List[MediaType] = List(`rfc822`, `http`, `disposition-notification`, `tracking-status`, `s-http`, `global-headers`, `imdn+xml`, `vnd.si.simp`, `sip`, `feedback-report`, `sipfrag`, `global-disposition-notification`, `delivery-status`, `external-body`, `partial`, `bhttp`, `global-delivery-status`, `vnd.wfa.wsc`, `global`, `cpim`, `news`)
...
lazy val `mpeg`: MediaType =
  new MediaType("audio", "mpeg", compressible = false, binary = true, List("mpga", "mp2", "mp2a", "mp3", "m2a", "m3a"))
...
lazy val `aptx`: MediaType =
  ...
  lazy val all: List[MediaType] = List(`vnd.4sb`, `evrc1`, `dsr-es201108`, `vnd.everad.plj`, `vnd.dece.audio`, `rtx`, `vnd.ms-playready.media.pya`, `evrcnw1`, `flexfec`, `red`, `vnd.dolby.heaac.1`, `1d-interleaved-parityfec`, `vnd.nuera.ecelp9600`, `silk`, `pcmu-wb`, `vnd.dts`, `vnd.dolby.pl2x`, `encaprtp`, `vnd.dolby.mps`, `evrcb1`, `parityfec`, `x-matroska`, `x-realaudio`, `vnd.nuera.ecelp4800`, `vnd.digital-winds`, `smv`, `g7221`, `vmr-wb`, `vnd.celp`, `g726-40`, `g722`, `vnd.dra`, `pcmu`, `vnd.dolby.pulse.1`, `lpc`, `melp600`, `x-wav`, `l20`, `basic`, `asc`, `speex`, `raptorfec`, `vnd.cns.anp1`, `evrcwb1`, `mpeg`, `atrac-x`, `midi`, `smv-qcp`, `t38`, `scip`, `rtp-enc-aescm128`, `vnd.nuera.ecelp7470`, `evrc-qcp`, `prs.sid`, `dsr-es202050`, `vnd.lucent.voice`, `g726-32`, `g7291`, `webm`, `melp2400`, `cn`, `l8`, `vnd.wave`, `xm`, `atrac3`, `pcma`, `tetra_acelp_bb`, `vnd.dts.hd`, `x-caf`, `amr`, `gsm`, `ulpfec`, `aac`, `wave`, `sp-midi`, `vnd.nortel.vbk`, `uemclip`, `mpa`, `x-flac`, `vnd.rn-realaudio`, `g723`, `g726-24`, `tsvcis`, `vnd.rip`, `mpa-robust`, `vnd.sealedmedia.softseal.mpeg`, `s3m`, `adpcm`, `g711-0`, `fwdred`, `x-m4a`, `evs`, `vnd.dolby.mlp`, `vnd.rhetorex.32kadpcm`, `vorbis`, `dat12`, `clearmode`, `x-mpegurl`, `vnd.audiokoz`, `musepack`, `usac`, `vnd.nokia.mobile-xmf`, `dv`, `g728`, `evrcwb`, `vnd.presonus.multitrack`, `g726-16`, `mpeg4-generic`, `ilbc`, `mp4`, `x-aiff`, `x-pn-realaudio`, `x-aac`, `vnd.dolby.heaac.2`, `amr-wb+`, `dsr-es202211`, `smv0`, `bv16`, `g729`, `x-tta`, `g729e`, `melp`, `mobile-xmf`, `dls`, `evrc0`, `vorbis-config`, `gsm-efr`, `rtp-midi`, `vnd.dlna.adts`, `vnd.vmx.cvsd`, `vnd.dvb.file`, `isac`, `telephone-event`, `l16`, `3gpp2`, `melp1200`, `vnd.cns.inf1`, `wav`, `bv32`, `pcma-wb`, `ac3`, `vnd.qcelp`, `vnd.octel.sbc`, `atrac-advanced-lossless`, `qcelp`, `x-pn-realaudio-plugin`, `g719`, `tone`, `dvi4`, `vnd.hns.audio`, `x-ms-wax`, `g729d`, `t140c`, `32kadpcm`, `mp3`, `evrcnw`, `vnd.cisco.nse`, `opus`, `evrcb0`, `3gpp`, `ogg`, `vnd.dolby.pl2z`, `vnd.cmles.radio-events`, `evrc`, `vnd.dolby.pl2`, `mhas`, `l24`, `vnd.dts.uhd`, `x-ms-wma`, `tetra_acelp`, `gsm-hr-08`, `eac3`, `evrcwb0`, `vdvi`, `dsr-es202212`, `rtploopback`, `mp4a-latm`, `sofa`, `amr-wb`, `evrcb`, `ip-mr_v2.5`, `evrcnw0`, `vnd.3gpp.iufp`, `aptx`)
...
lazy val `digest`: MediaType =
  ...
  lazy val all: List[MediaType] = List(`form-data`, `byteranges`, `vnd.bint.med-plus`, `mixed`, `report`, `multilingual`, `x-mixed-replace`, `encrypted`, `header-set`, `voice-message`, `related`, `signed`, `appledouble`, `alternative`, `parallel`, `digest`)
