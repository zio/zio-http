...
trait HtmlAttributes {
  ...
  val ariaControls: Dom.PartialAttribute         = Dom.attr("aria-controls")
  val ariaDescribedby: Dom.PartialAttribute      = Dom.attr("aria-describedby")
  ...
  val ariaFlowto: Dom.PartialAttribute           = Dom.attr("aria-flowto")
  ...
  val ariaLabelledby: Dom.PartialAttribute       = Dom.attr("aria-labelledby")
  ...
  val ariaOwns: Dom.PartialAttribute             = Dom.attr("aria-owns")
  ...
  val `class`: Dom.PartialAttribute              = Dom.attr("class")
  val className: Dom.PartialAttribute            = Dom.attr("class")
  ...
  val rel: Dom.PartialAttribute                  = Dom.attr("rel")
