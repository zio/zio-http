...
| `Server.responseCompression(contentSizeThreshold, options)` | Creates a Server with support for Response Compression. If `contentSizeThreshold` is set to `0`, compression will be enabled for all responses.                                     |
