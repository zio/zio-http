...
// CI Configuration
ThisBuild / githubWorkflowEnv += ("JAVA_OPTS" -> "-Xms15G -Xmx15G -Xss10M -XX:MaxMetaspaceSize=2G -XX:ReservedCodeCacheSize=256M -Dfile.encoding=UTF-8")
ThisBuild / githubWorkflowEnv += ("JVM_OPTS" -> "-Xms15G -Xmx15G -Xss10M -XX:MaxMetaspaceSize=2G -XX:ReservedCodeCacheSize=256M -Dfile.encoding=UTF-8")
