...
//   val messageFilter: Http[Any, Nothing, WebSocketChannel, (WebSocketChannelEvent, String)] =
//     Http.collect[WebSocketChannel] { case ChannelEvent(channel, ChannelRead(WebSocketFrame.Text(message))) =>
//       (channel, message)
//     }
